...
type Project struct {
	XKey                string             `json:"_key,omitempty" firestore:"_key,omitempty"`                                                                                           // @gotags: firestore:"_key,omitempty"
	Id                  string             `json:"id,omitempty" gorm:"primaryKey;autoIncrement:false" firestore:"id,omitempty"`                                                         // @gotags: gorm:"primaryKey;autoIncrement:false" firestore:"id,omitempty"
	...
	Plugins             []*PluginDetails   `json:"plugins,omitempty" firestore:"plugins,omitempty"`                                                                                     // @gotags: firestore:"plugins,omitempty"
	Addons              *AddOnsDetails     `json:"addons,omitempty" gorm:"foreignKey:ProjectID" firestore:"addons,omitempty"`                                                           // @gotags: gorm:"foreignKey:ProjectID" firestore:"addons,omitempty"
	Tokens              []*APIToken        `json:"tokens,omitempty" gorm:"foreignKey:ProjectID" firestore:"tokens,omitempty"`                                                           // @gotags: gorm:"foreignKey:ProjectID" firestore:"tokens,omitempty"
	...
	Driver              *DriverCredentials `json:"driver,omitempty" gorm:"foreignKey:ProjectID" firestore:"driver,omitempty"`                                                           // @gotags: gorm:"foreignKey:ProjectID" firestore:"driver,omitempty"
	...
	Limits              *UsagesTracking    `json:"limits,omitempty" gorm:"foreignKey:ProjectID" firestore:"limits,omitempty"`                                                           // @gotags: gorm:"foreignKey:ProjectID" firestore:"limits,omitempty"
	OwnerId             string             `json:"owner_id,omitempty" firestore:"owner_id,omitempty"`                                                                                   // @gotags: firestore:"owner_id,omitempty"
	Teams               []*TeamMembers     `json:"teams,omitempty" gorm:"foreignKey:ProjectID" firestore:"teams,omitempty"`                                                             // @gotags: gorm:"foreignKey:ProjectID" firestore:"teams,omitempty"
	SystemMessages      []*SystemMessage   `json:"system_messages,omitempty" firestore:"system_messages,omitempty"`                                                                     // @gotags: firestore:"system_messages,omitempty"
	Workspaces          []*Workspace       `json:"workspaces,omitempty" firestore:"workspaces,omitempty"`                                                                               // @gotags: firestore:"workspaces,omitempty"
	ActivatedPluginsIds *ActivatedPlugins  `json:"activated_plugins_ids,omitempty" firestore:"activated_plugins_ids,omitempty"`                                                         // @gotags: firestore:"activated_plugins_ids,omitempty"
