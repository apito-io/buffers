...
type MonthlySubscription struct {
	...
	Status       string              `protobuf:"bytes,3,opt,name=status,proto3" json:"status,omitempty" firestore:"status,omitempty"`
	CheckoutData *CommonCheckoutData `protobuf:"bytes,4,opt,name=checkout_data,json=checkoutData,proto3" json:"checkout_data,omitempty" firestore:"checkout_data,omitempty"`
}
...
func (m *MonthlySubscription) GetStatus() string {
	if m != nil {
		return m.Status
	}
	return ""
...
func (m *MonthlySubscription) GetCheckoutData() *CommonCheckoutData {
	if m != nil {
		return m.CheckoutData
	}
	return nil
}

type CommonCheckoutData struct {
	CheckoutId     string  `protobuf:"bytes,1,opt,name=checkout_id,json=checkoutId,proto3" json:"checkout_id,omitempty" firestore:"checkout_id,omitempty"`
	...
	ProductCode    string  `protobuf:"bytes,6,opt,name=product_code,json=productCode,proto3" json:"product_code,omitempty" firestore:"product_code,omitempty"`
	Quantity       string  `protobuf:"bytes,7,opt,name=quantity,proto3" json:"quantity,omitempty" firestore:"quantity,omitempty"`
	PaymentMethod  string  `protobuf:"bytes,8,opt,name=payment_method,json=paymentMethod,proto3" json:"payment_method,omitempty" firestore:"payment_method,omitempty"`
	Earning        float64 `protobuf:"fixed64,9,opt,name=earning,proto3" json:"earning,omitempty" firestore:"earning,omitempty"`
	Fee            float64 `protobuf:"fixed64,10,opt,name=fee,proto3" json:"fee,omitempty" firestore:"fee,omitempty"`
	Tax            float64 `protobuf:"fixed64,11,opt,name=tax,proto3" json:"tax,omitempty" firestore:"tax,omitempty"`
}

func (m *CommonCheckoutData) Reset()         { *m = CommonCheckoutData{} }
func (m *CommonCheckoutData) String() string { return proto.CompactTextString(m) }
func (*CommonCheckoutData) ProtoMessage()    {}
func (*CommonCheckoutData) Descriptor() ([]byte, []int) {
	return fileDescriptor_555bd8c177793206, []int{30}
}
func (m *CommonCheckoutData) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *CommonCheckoutData) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CommonCheckoutData.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *CommonCheckoutData) XXX_Merge(src proto.Message) {
	xxx_messageInfo_CommonCheckoutData.Merge(m, src)
}
func (m *CommonCheckoutData) XXX_Size() int {
	return m.Size()
}
func (m *CommonCheckoutData) XXX_DiscardUnknown() {
	xxx_messageInfo_CommonCheckoutData.DiscardUnknown(m)
}

var xxx_messageInfo_CommonCheckoutData proto.InternalMessageInfo

func (m *CommonCheckoutData) GetCheckoutId() string {
	if m != nil {
		return m.CheckoutId
	}
	return ""
...
func (m *CommonCheckoutData) GetCheckoutSystem() string {
	if m != nil {
...
func (m *CommonCheckoutData) GetPlanCode() string {
	if m != nil {
		return m.PlanCode
	}
	return ""
...
func (m *CommonCheckoutData) GetProductAmount() float64 {
	if m != nil {
...
func (m *CommonCheckoutData) GetDiscountCode() string {
	if m != nil {
...
func (m *CommonCheckoutData) GetProductCode() string {
	if m != nil {
...
func (m *CommonCheckoutData) GetQuantity() string {
	if m != nil {
		return m.Quantity
	}
	return ""
...
func (m *CommonCheckoutData) GetPaymentMethod() string {
	if m != nil {
		return m.PaymentMethod
	}
	return ""
...
func (m *CommonCheckoutData) GetEarning() float64 {
	if m != nil {
		return m.Earning
	}
	return 0
...
func (m *CommonCheckoutData) GetFee() float64 {
	if m != nil {
		return m.Fee
	}
	return 0
...
func (m *CommonCheckoutData) GetTax() float64 {
	if m != nil {
		return m.Tax
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*CommonCheckoutData)(nil), "protobuff.CommonCheckoutData")
...
var fileDescriptor_555bd8c177793206 = []byte{
	...
	,
}
...
func (m *MonthlySubscription) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.CheckoutData != nil {
		{
			size, err := m.CheckoutData.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *CommonCheckoutData) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *CommonCheckoutData) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *CommonCheckoutData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.ProductCode) > 0 {
		...
		i = encodeVarintCommon(dAtA, i, uint64(len(m.ProductCode)))
		i--
		dAtA[i] = 0x32
	}
	...
	if len(m.CheckoutId) > 0 {
		i -= len(m.CheckoutId)
		copy(dAtA[i:], m.CheckoutId)
		i = encodeVarintCommon(dAtA, i, uint64(len(m.CheckoutId)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *MonthlySubscription) Size() (n int) {
	...
	if m.CheckoutData != nil {
		l = m.CheckoutData.Size()
		n += 1 + l + sovCommon(uint64(l))
	}
	return n
}

func (m *CommonCheckoutData) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MonthlySubscription) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field CheckoutData", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.CheckoutData == nil {
				m.CheckoutData = &CommonCheckoutData{}
			}
			if err := m.CheckoutData.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *CommonCheckoutData) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: CommonCheckoutData: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: CommonCheckoutData: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.CheckoutId = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
