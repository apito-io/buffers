...
type FileData struct {
	FileExtension string `protobuf:"bytes,1,opt,name=FileExtension,proto3" json:"FileExtension,omitempty"`
...
func (m *FileData) GetFileExtension() string {
	if m != nil {
...
func (m *FileData) GetProjectId() string {
	if m != nil {
		return m.ProjectId
	}
	return ""
...
func (m *FileData) GetModelName() string {
	if m != nil {
		return m.ModelName
	}
	return ""
...
func (m *FileData) GetContentType() string {
	if m != nil {
...
type BigFileChunk struct {
	// Fine Name
	FileInfo *FileData `protobuf:"bytes,11,opt,name=FileInfo,proto3" json:"FileInfo,omitempty"`
...
func (m *BigFileChunk) GetFileInfo() *FileData {
	if m != nil {
		return m.FileInfo
	}
	return nil
...
type BigFileAck struct {
	...
	S3Path           string `protobuf:"bytes,6,opt,name=S3Path,proto3" json:"S3Path,omitempty"`
...
func (m *BigFileAck) GetS3Path() string {
	if m != nil {
		return m.S3Path
	}
	return ""
...
func (m *BigFileAck) GetUploadId() string {
	if m != nil {
		return m.UploadId
	}
	return ""
...
func init() {
	proto.RegisterType((*FileData)(nil), "protobuff.FileData")
...
var fileDescriptor_67c46bd41e8571bd = []byte{
	...
	,
}
...
func (m *FileData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if len(m.ContentType) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.ContentType)))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.ModelName) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.ModelName)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.ProjectId) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.ProjectId)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Filename) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.Filename)))
		i--
		dAtA[i] = 0x12
	}
	if len(m.FileExtension) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.FileExtension)))
		i--
		dAtA[i] = 0xa
	}
...
func (m *BigFileAck) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UploadId) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.UploadId)))
		i--
		dAtA[i] = 0x3a
	}
	if len(m.S3Path) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.S3Path)))
		i--
		dAtA[i] = 0x32
	}
	if len(m.Err) > 0 {
