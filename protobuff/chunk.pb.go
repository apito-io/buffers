...
type FileData struct {
	...
	IsImage       string `protobuf:"bytes,4,opt,name=is_image,json=isImage,proto3" json:"is_image,omitempty"`
}
...
func (m *FileData) GetRemotePath() string {
	if m != nil {
		return m.RemotePath
	}
	return ""
...
func (m *FileData) GetIsImage() string {
	if m != nil {
		return m.IsImage
	}
	return ""
...
var fileDescriptor_67c46bd41e8571bd = []byte{
	...
	,
}
...
func (m *FileData) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.IsImage) > 0 {
		i -= len(m.IsImage)
		copy(dAtA[i:], m.IsImage)
		i = encodeVarintChunk(dAtA, i, uint64(len(m.IsImage)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.RemotePath) > 0 {
		...
		i = encodeVarintChunk(dAtA, i, uint64(len(m.RemotePath)))
		i--
		dAtA[i] = 0x1a
	}
	if len(m.Filename) > 0 {
...
func (m *FileData) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			...
			m.IsImage = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
