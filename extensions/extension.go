...
type FileDetails struct {
	...
	RemoteFilePath   string        `protobuf:"bytes,5,opt,name=remote_file_path,json=remote_file_path,proto3" json:"remote_file_path,omitempty" firestore:"remote_file_path,omitempty"`
	UploadedFullPath string        `protobuf:"bytes,6,opt,name=uploaded_full_path,json=uploaded_full_path,proto3" json:"uploaded_full_path,omitempty" firestore:"uploaded_full_path,omitempty"`
	...
	Size             int64         `protobuf:"varint,7,opt,name=size,proto3" json:"size,omitempty" firestore:"size,omitempty"`
